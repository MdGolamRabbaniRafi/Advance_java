...
public class DBUtil {
    ...
    public static void create(User user) throws SQLException, ClassNotFoundException {
        Connection connection = ConnectionManager.getConnection();
        PreparedStatement preparedStatement = connection.prepareStatement("INSERT INTO users (Id, FullName, Email, DOB, Gender, Quata, Country) VALUES (?, ?, ?, ?, ?, ?, ?)");
    ...
    public static void update(User user) throws SQLException, ClassNotFoundException {
        Connection connection = ConnectionManager.getConnection();
        PreparedStatement preparedStatement = connection.prepareStatement("UPDATE users SET FullName = ?, Email = ?, DOB = ?, Gender = ?, Quata = ?, Country = ? WHERE Id = ?");
        ...
        preparedStatement.setString(5, user.getQuataValues().toString());
